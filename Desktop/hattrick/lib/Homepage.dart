...
Future<void> getNews() async {
  ...
  void dispose() {
    isMounted = false;
    getNews(); // Set isMounted to false when the widget is disposed
    super.dispose();
  }
  ...
  Future<void> fetchAllUsers() async {
    ...
    if (response.statusCode == 200) {
      final List<dynamic> data = json.decode(response.body);
      setState(() {
        all_leads = data.map((userJson) => AUser.fromJson(userJson)).toList();
      });
    } else {
      throw Exception('Failed to load users');
    }
            ...
            child: ListView(
              children: [
                        ...
                        ? [
                            ...
                            GestureDetector(
                              child: Container(
                                ...
                                height: 36.06,
                                decoration:
                                    BoxDecoration(color: Color(0xFF717FC9)),
                                child: Center(
                                  child: Text(
                                    'Get Verified',
                                    textAlign: TextAlign.center,
                ...
                Container(
                    ...
                    child: !me["username"].toString().isEmpty
                        ? Center(
                            child: ListTile(
                            leading: Text(
                            ...
                            subtitle: Text(auth.currentuser!.city.toString(),
                                style: GoogleFonts.poppins(
                    ...
                    items: [
                      ...
                      Container(
                          child: Column(
                            ...
                            Text(
                                auth.currentuser!.is_subscribed
                                    ? ' Play and Earn with Master\’s Quiz Earn \n Up To N10,000 for each quiz'
                                    : ' Subscribe to Play in the Master\’s, Quiz \n Earn Up To N10,000 for each quiz',
                                style: GoogleFonts.poppins(
                                  color: Colors.white,
                                  fontSize: 12,
                                  fontWeight: FontWeight.w700,
                      ...
                      Container(
                          child: Column(
                            ...
                            SizedBox(height: 19),
                            Text(
                                " Play Practice Games to get \n a glimpse of the world of Hattrick",
                                style: GoogleFonts.poppins(
                                  color: Colors.white,
                                  fontSize: 12,
                                  fontWeight: FontWeight.w700,
                      ...
                      Container(
                          child: Column(
                            ...
                            Text(
                                auth.currentuser!.is_subscribed
                                    ? 'Subscribe to Score A Hattrick and Win N1,000,000'
                                    : 'Score A Hattrick and Win N1,000,000',
                                style: GoogleFonts.poppins(
                                  color: Colors.white,
                                  fontSize: 12,
                                  fontWeight: FontWeight.w700,
